...
public class Constants {
    ...
    public static final String CHANGE_SETTINGS = """
            ***********************************************************************
            ...
            [!!!ВНИМАНИЕ!!! ВО ВРЕМЯ ИГРЫ => ПАУЗА/настройки: "p"]
            ***********************************************************************
            """;
    ...
    public static final String ALL_ANIMAL_COUNT_BORN_BABY = """
            #######################################################################
            На сколько единиц увеличить (- уменьшить) количество приплода
            у всех %s ? (Настройки по умолчанию: 20 детёнышей)
    ...
    public static final String SET_COUNT = """
            #######################################################################
            Пожалуйста введите максимальное количество на одной клетке для %s
    ...
    public static final String SET_COUNT_MAX_BORN_BABY = """
            #######################################################################
            Пожалуйста введите количество приплода для %s
            (целое число):
            #######################################################################
            """;
